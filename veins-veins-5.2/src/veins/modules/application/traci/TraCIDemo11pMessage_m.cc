...
void TraCIDemo11pMessage::copy(const TraCIDemo11pMessage& other)
{
    ...
    this->nodeMobilityCoord = other.nodeMobilityCoord;
    this->isBeacon_ = other.isBeacon_;
...
void TraCIDemo11pMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->nodeMobilityCoord);
    doParsimPacking(b,this->isBeacon_);
...
void TraCIDemo11pMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->nodeMobilityCoord);
    doParsimUnpacking(b,this->isBeacon_);
...
const Coord& TraCIDemo11pMessage::getNodeMobilityCoord() const
{
    return this->nodeMobilityCoord;
}

void TraCIDemo11pMessage::setNodeMobilityCoord(const Coord& nodeMobilityCoord)
{
    this->nodeMobilityCoord = nodeMobilityCoord;
}

bool TraCIDemo11pMessage::isBeacon() const
{
    return this->isBeacon_;
}

void TraCIDemo11pMessage::setIsBeacon(bool isBeacon)
{
    this->isBeacon_ = isBeacon;
}

int TraCIDemo11pMessage::getHopCount() const
{
    return this->hopCount;
}

void TraCIDemo11pMessage::setHopCount(int hopCount)
{
...
double TraCIDemo11pMessage::getDirection() const
{
    return this->direction;
}

void TraCIDemo11pMessage::setDirection(double direction)
{
...
unsigned int TraCIDemo11pMessageDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        0,    // FIELD_nodeMobilityCoord
        FD_ISEDITABLE,    // FIELD_isBeacon
...
int TraCIDemo11pMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "nodeMobilityCoord") == 0) return baseIndex + 3;
    if (strcmp(fieldName, "isBeacon") == 0) return baseIndex + 4;
    if (strcmp(fieldName, "hopCount") == 0) return baseIndex + 5;
    if (strcmp(fieldName, "speed") == 0) return baseIndex + 6;
...
const char *TraCIDemo11pMessageDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "int",    // FIELD_serial
        "veins::Coord",    // FIELD_nodeMobilityCoord
        "bool",    // FIELD_isBeacon
        "int",    // FIELD_hopCount
        "double",    // FIELD_speed
...
std::string TraCIDemo11pMessageDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_nodeMobilityCoord: return "";
        case FIELD_isBeacon: return bool2string(pp->isBeacon());
        case FIELD_hopCount: return long2string(pp->getHopCount());
        case FIELD_speed: return double2string(pp->getSpeed());
        case FIELD_direction: return double2string(pp->getDirection());
        default: return "";
    }
}
...
void TraCIDemo11pMessageDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_isBeacon: pp->setIsBeacon(string2bool(value)); break;
        case FIELD_hopCount: pp->setHopCount(string2long(value)); break;
        case FIELD_speed: pp->setSpeed(string2double(value)); break;
        case FIELD_direction: pp->setDirection(string2double(value)); break;
...
omnetpp::cValue TraCIDemo11pMessageDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_nodeMobilityCoord: return omnetpp::toAnyPtr(&pp->getNodeMobilityCoord()); break;
        case FIELD_isBeacon: return pp->isBeacon();
...
void TraCIDemo11pMessageDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_isBeacon: pp->setIsBeacon(value.boolValue()); break;
        ...
        case FIELD_direction: pp->setDirection(value.doubleValue()); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'TraCIDemo11pMessage'", field);
    }
}
